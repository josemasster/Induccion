...
import (
	...
	"github.com/beego/beego/Agenda_api/models"
...
func (c *CorreoselectronicosController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCorreoselectronicos(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"Sucess": true, "Status": "201", "Message": "Registration sucessful", "Data": v}
		} else {
			logs.Error(err)
			c.Data["message"] = "Errors service POST: The request contains a incorrect data type or an invalid parameter"
			c.Abort("400")
		}
	} else {
		logs.Error(err)
...
func (c *CorreoselectronicosController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"Sucess": true, "Status": "201", "Message": "Registration sucessful", "Data": l}
	}
	c.ServeJSON()
}
...
func (c *CorreoselectronicosController) Delete() {
	...
	if err := models.DeleteCorreoselectronicos(id); err == nil {
		...
		c.Data["json"] = map[string]interface{}{"Sucess": true, "Status": "201", "Message": "Registration sucessful", "Data": d}
	} else {
		logs.Error(err)
		c.Data["message"] = "Errors service POST: The request contains a incorrect data type or an invalid parameter"
		c.Abort("400")
